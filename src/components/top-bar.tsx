                ...
                <div className={'h-8 rounded-lg border flex items-center justify-center gap-0.5'}>
                    <button type={'button'} className={'px-1.5'}>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.99996 5.33333H9.99996C9.99996 5.33333 13.3333 5.33333 13.3333 8.47059C13.3333 12 9.99996 12 9.99996 12H4.19044M4.99996 7.66667L2.66663 5.33333L4.99996 3" stroke="#637083" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
                    <Separator
                        orientation="vertical"
                    ...
                    <button type={'button'} className={'px-1.5'}>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13 5.33333H6.00004C6.00004 5.33333 2.66671 5.33333 2.66671 8.47059C2.66671 12 6.00004 12 6.00004 12H11.8096M11 7.66667L13.3334 5.33333L11 3" stroke="#637083" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
                </div>
